/*
@name designer.action.auto.node.export.exportGraphlet
...
RETURN 'Export Graphlet' AS name,
       'Export' AS group,
       'download' AS icon,
       [] AS params,
       [] AS implicitParams,
...
/*
@name designer.action.auto.node.export.exportGraphlet_do
...
MATCH (graphlet:Graphlet:_Identifiable {uuid: contextUuid})
