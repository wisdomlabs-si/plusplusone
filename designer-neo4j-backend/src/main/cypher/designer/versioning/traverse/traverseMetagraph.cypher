/*
@name designer.traverse.traverseMetagraph
...
CALL apoc.log.debug("[designer.traverse.traverseMetagraph] Traverse Metagraph with uuid %s and name %s", [metagraph.uuid, metagraph.name])
...
RETURN  metagraph + nodes AS nodes,
