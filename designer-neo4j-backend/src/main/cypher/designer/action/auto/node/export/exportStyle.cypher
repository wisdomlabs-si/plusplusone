/*
@name designer.action.auto.node.export.exportStyle
...
/*
@name designer.action.auto.node.export.exportStyle_do
...
MATCH (style:Style:_Identifiable {uuid: contextUuid})
