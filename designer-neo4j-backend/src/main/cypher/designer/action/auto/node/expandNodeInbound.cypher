/*
@name designer.action.auto.node.expandNodeInbound
...
/*
@name designer.action.auto.node.expandNodeInbound_do
...
RETURN {neighbourNode: neighbour,
        incomingRelationship: rel} AS result,
       0 AS statusCode,
       '' AS message,
       'APPEND' AS strategy;
